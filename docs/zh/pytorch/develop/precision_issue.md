...
完成初步排查后，通常借助[精度工具 msprobe](https://gitcode.com/Ascend/msprobe)对不同问题场景进行分析和定位，该工具提供了使用指导和[大模型训练精度定位指南](https://www.hiascend.com/document/detail/zh/mindstudio/latest/practicalcases/LargeModelTrainingAccuracy/docs/zh/best_practices/train_debug_guide.md)。
