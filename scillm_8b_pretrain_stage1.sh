...
MONITOR_DIR=${MONITOR_DIR:-./monitoring/${MODEL_NAME}_stage1_nn${NNODES}tp${TP}pp${PP}cp${CP}mbs${MBS}gbs${GBS}}
...
WANDB_EXP_NAME=${WANDB_EXP_NAME:-${MODEL_NAME}-stage1-${SEQ_LENGTH}-nn${NNODES}-tp${TP}-pp${PP}-cp${CP}}
