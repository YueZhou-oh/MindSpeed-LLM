...
mkdir -p ./logs
set +e
torchrun $DISTRIBUTED_ARGS train_fsdp2.py tests/st/shell_scripts/pretrain_deepseek4_flash_1k_fsdp2_cp2.yaml 2>&1 | tee logs/pretrain_deepseek4_flash_1k_cp2_${TIMESTAMP}.log
