...
from mindspeed_llm.tasks.models.transformer.minimax_attention import MinimaxAttention
...
if args.tensor_model_parallel_size > 1:
    raise AssertionError('Currently MiniMax-m27 only support tp=1')
...
layer_spec = ModuleSpec(
    ...
    submodules=TransformerLayerSubmodules(
        ...
        mlp=_get_mlp_module_spec(use_te=use_te, num_experts=num_experts, moe_grouped_gemm=moe_grouped_gemm),
