...
class MultiTokenPredictionFeature(MindSpeedFeature):
    def __init__(self):
        super().__init__(feature_name="multi-token-prediction", optimization_level=0)
    ...
    def register_patches(self, patch_manager, args):
        ...
        from mindspeed_llm.core.transformer.multi_token_prediction import mtp_reduce_loss_in_tracker
        ...
        patch_manager.register_patch(
            'megatron.core.transformer.multi_token_prediction.MultiTokenPredictionLayer.__init__',
            mtp_layer_init_wrapper,
        )
        ...
        patch_manager.register_patch(
            'megatron.core.transformer.multi_token_prediction.MultiTokenPredictionBlock._build_layers',
            mtp_block_build_layers_wrapper,
        )
        patch_manager.register_patch(
            'megatron.core.transformer.multi_token_prediction.MultiTokenPredictionBlock.forward', mtp_block_forward
        )
