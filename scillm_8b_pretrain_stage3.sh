...
DATA_PATH="
0.10 /dpc-zhouy/zhouy/pretraining/c4_text_document
0.15 /dpc-zhouy/zhouy/pretraining/wiki_text_document
0.05 /dpc-zhouy/zhouy/pretraining/stackexchange_text_document
0.35 /dpc-zhouy/zhouy/pretraining/arxiv_text_document
0.10 /dpc-zhouy/zhouy/pretraining/cc_2020_05_en_head_text_document
0.15 /dpc-zhouy/zhouy/pretraining/cc_2022_05_en_head_text_document
0.10 /dpc-zhouy/zhouy/pretraining/cc_2023_06_en_head_text_document
"
...
MONITOR_DIR=${MONITOR_DIR:-./monitoring/${MODEL_NAME}_stage3_nn${NNODES}tp${TP}pp${PP}cp${CP}mbs${MBS}gbs${GBS}}
...
WANDB_EXP_NAME=${WANDB_EXP_NAME:-${MODEL_NAME}-stage3-${SEQ_LENGTH}-nn${NNODES}-tp${TP}-pp${PP}-cp${CP}}
