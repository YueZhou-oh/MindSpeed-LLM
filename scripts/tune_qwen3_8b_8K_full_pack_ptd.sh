...
CKPT_SAVE_DIR="/dpc-zhouy/zhouy/ckpts/scillm_ft_pack_demo_mc"
DATA_PATH="/dpc-zhouy/zhouy/data/finetune_dataset/sharegpt_pack"
...
LOG_FILE="./logs_run/finetune_scillm_qwen3_8b_sl${SEQ_LENGTH}_nn${NNODES}rank${NODE_RANK}tp${TP}pp${PP}mbs${MBS}gbs${GBS}_${TIMESTAMP}.log"
...
WANDB_EXP_NAME=${WANDB_EXP_NAME:-ft-scillm-qwen3-8b-sl${SEQ_LENGTH}-nn${NNODES}-tp${TP}-pp${PP}}
