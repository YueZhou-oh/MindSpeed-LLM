...
def _get_metric_writer_rank(args):
    """Rank that owns loss/metric logging."""
...
def _set_tensorboard_writer(args):
    ...
    if hasattr(args, 'tensorboard_dir') and \
       args.tensorboard_dir and args.rank == _get_metric_writer_rank(args):
        try:
...
def _set_wandb_writer(args):
    ...
    _ensure_var_is_not_initialized(_GLOBAL_WANDB_WRITER,
                                   'wandb writer')
    if getattr(args, 'wandb_project', '') and args.rank == _get_metric_writer_rank(args):
